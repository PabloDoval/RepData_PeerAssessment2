...
The initial obvious analysis to perform is to evaluate which kind of events have a greater impact in public health, in terms of injuries and fatalities. Summarizing the 
...
With regards to the time evolution, it seems there is an improvement...
